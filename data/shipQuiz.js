export const shipQuizData = [
  {
    ...
    questions: [
      ...
      {
        question: "Which island is known for the famous Neolithic site Skara Brae?",
        options: ["Orkney", "Shetland", "Isle of Skye"],
        correctAnswer: "Orkney"
      },
      {
        question: "Which island is the site of the annual Trooping the Colour ceremony?",
      ...
      {
        question: "Which island is known for its beautiful beaches and resorts?",
        options: ["Isle of Wight", "Isle of Man", "Anglesey"],
        correctAnswer: "Isle of Wight"
      },
      {
        question: "Which island is famous for its ancient stone circles and standing stones?",
        options: ["Isle of Lewis", "Isle of Mull", "Skye"],
        correctAnswer: "Isle of Lewis"
      },
      {
        question: "What is the name of the largest island in the Outer Hebrides?",
        options: ["Lewis", "Harris", "Skye"],
        correctAnswer: "Lewis"
      },
      {
        question: "Which island is known for its stunning cliffs and natural beauty?",
  ...
  },
  {
    ...
    questions: [
      {
        question: "Who was the British admiral known for his victory at the Battle of Trafalgar?",
        options: ["John Jellicoe", "Horatio Nelson", "Francis Drake"],
        correctAnswer: "Horatio Nelson"
      },
      {
        question: "Which admiral is known for his circumnavigation of the globe?",
      ...
      {
        question: "Who was the admiral that played a key role during the Napoleonic Wars?",
      ...
      {
        question: "Who was the British admiral known for his raids in the Caribbean?",
        options: ["Horatio Nelson", "Francis Drake", "Edward Vernon"],
        correctAnswer: "Francis Drake"
      },
      {
        question: "Who commanded the fleet during the American Revolutionary War?",
        options: ["Richard Howe", "Samuel Hood", "James Gambier"],
        correctAnswer: "Richard Howe"
      },
      {
        question: "Which admiral is famous for his victory at the Battle of Cape St. Vincent?",
        options: ["Horatio Nelson", "John Jervis", "Edward Vernon"],
        correctAnswer: "John Jervis"
      },
      {
        question: "Who is regarded as the first British admiral to circumnavigate the globe?",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["The defeat of the Spanish Armada", "The Battle of Waterloo", "The signing of the Magna Carta"],
      ...
      {
        question: "In which year did Britain formally recognize the independence of the United States?",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "Which island group is located northeast of mainland Scotland?",
        options: ["Shetland", "Orkney", "Hebrides"],
        correctAnswer: "Shetland"
      },
      {
        question: "What body of water separates Great Britain from mainland Europe?",
        options: ["English Channel", "North Sea", "Irish Sea"],
        correctAnswer: "English Channel"
      },
      {
        question: "Which island is known for its historic castles and beautiful landscapes?",
      ...
      {
        question: "What is the name of the largest island in the Inner Hebrides?",
      ...
      {
        question: "What is the name of the small island off the coast of Scotland known for its puffins?",
        options: ["Staffa", "Sula Sgeir", "Skye"],
        correctAnswer: "Sula Sgeir"
      },
      {
        question: "Which island is known for its vibrant wildlife, including seals and otters?",
  ...
  },
  {
    ...
    questions: [
      {
        question: "Which admiral was known for mapping the Australian coastline?",
      ...
      {
        question: "What was the name of James Cook's ship during his first voyage?",
        options: ["The Endeavour", "The Discovery", "The Beagle"],
        correctAnswer: "The Endeavour"
      },
      {
        question: "Which admiral made significant contributions to the mapping of the Pacific?",
      ...
      {
        question: "Which admiral's expeditions helped establish British territories in the Pacific?",
        options: ["Horatio Nelson", "James Cook", "Francis Drake"],
        correctAnswer: "James Cook"
      },
      {
        question: "What was the primary goal of Francis Drake's circumnavigation?",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["A supply ship", "The lead ship in a fleet", "A reconnaissance vessel"],
      ...
      },
      {
        ...
        options: ["The movement of ships", "Docking procedures", "Crew training"],
        correctAnswer: "The movement of ships"
      },
      {
        question: "What is a \"battleship\"?",
        options: ["A cargo ship", "A heavily armed warship", "A fishing vessel"],
        correctAnswer: "A heavily armed warship"
      },
      {
        question: "What does \"naval intelligence\" refer to?",
        options: ["Information about naval operations", "Shipbuilding data", "Weather forecasting"],
        correctAnswer: "Information about naval operations"
      },
      {
        question: "What is the main purpose of naval reconnaissance?",
        options: ["To gather information about enemy forces", "To conduct trade missions", "To perform humanitarian aid"],
        correctAnswer: "To gather information about enemy forces"
      },
      {
        question: "What is \"sea power\"?",
        options: ["The ability to control sea lanes", "The number of ships in a fleet", "Naval aviation strength"],
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["War of the Spanish Succession", "Anglo-Dutch Wars", "Napoleonic Wars"],
        correctAnswer: "Anglo-Dutch Wars"
      },
      {
        question: "What was the primary purpose of the Royal Navy in the 18th century?",
        options: ["Defense", "Exploration", "Trade"],
        correctAnswer: "Defense"
      },
      {
        question: "Which conflict solidified British naval dominance over France?",
      ...
      {
        question: "When was the Royal Navy's first significant naval engagement?",
        options: ["1545", "1588", "1600"],
        correctAnswer: "1588"
      },
      {
        question: "What event marked the decline of the Spanish Armada?",
        options: ["The Battle of Trafalgar", "The defeat of the Spanish Armada", "The War of the Roses"],
        correctAnswer: "The defeat of the Spanish Armada"
      },
      {
        question: "Which battle in 1794 was significant for the Royal Navy?",
        options: ["Battle of the Nile", "Battle of Trafalgar", "Battle of Cape St. Vincent"],
        correctAnswer: "Battle of Cape St. Vincent"
      },
      {
        question: "What was the primary naval strategy during the Napoleonic Wars?",
        options: ["Blockade", "Surprise attacks", "Open engagement"],
        correctAnswer: "Blockade"
      },
      {
        question: "When was the first female admiral appointed in the Royal Navy?",
    ...
    questions: [
      {
        ...
        options: ["Asymmetric warfare", "Blockade warfare", "Guerrilla warfare"],
        correctAnswer: "Blockade warfare"
      },
      {
        question: "What is \"naval artillery\"?",
        options: ["Weapons used in air combat", "Cannons and guns used on ships", "Submarine weaponry"],
      ...
      {
        question: "What type of naval operation focuses on amphibious landings?",
      ...
      },
      {
        ...
        options: ["To create barriers", "To destroy enemy ships", "To gather intelligence"],
        correctAnswer: "To destroy enemy ships"
      },
      {
        question: "What is \"dreadnought\" in naval terms?",
        options: ["A type of cargo ship", "A class of battleship", "A type of frigate"],
        correctAnswer: "A class of battleship"
      },
      {
        question: "What is the significance of naval logistics?",
        options: ["Supply and support operations", "Communication", "Offensive strategies"],
        correctAnswer: "Supply and support operations"
      },
      {
        question: "What is \"combined operations\" in naval warfare?",
        options: ["Cooperation with allies", "Using multiple ships", "Joint air and naval strikes"],
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Welcoming visitors", "Dismissal of sailors", "Calling for action"],
      ...
      },
      {
        ...
        options: ["Passing the equator", "Entering foreign waters", "A ceremonial event"],
      ...
      },
      {
        ...
        options: ["Rule Britannia", "The Drunken Sailor", "Land of Hope and Glory"],
      ...
      },
      {
        ...
        options: ["Tradition and history", "Modern practices", "Economic contributions"],
    ...
    questions: [
      {
        ...
        options: ["A small, fast warship", "A type of submarine", "An aircraft carrier"],
      ...
      {
        question: "What technology is used in modern naval warfare for targeting?",
        options: ["GPS", "Sonar", "Morse code"],
        correctAnswer: "GPS"
      },
      {
        question: "What does \"Aegis\" refer to in naval systems?",
        options: ["A type of ship", "An advanced radar system", "A naval doctrine"],
        correctAnswer: "An advanced radar system"
      },
      {
        question: "What is a \"nuclear submarine\"?",
        options: ["A submarine powered by nuclear energy", "A conventional submarine", "A surface vessel"],
        correctAnswer: "A submarine powered by nuclear energy"
      },
      {
        question: "What technology allows submarines to communicate underwater?",
        options: ["Sonar", "Radar", "Laser"],
        correctAnswer: "Sonar"
      },
      {
        question: "What is the function of a naval aircraft carrier?",
        options: ["To transport troops", "To launch and recover aircraft", "To patrol coastal waters"],
      ...
      },
      {
        ...
        options: ["A vessel operated without crew", "A cargo ship", "A rescue boat"],
